...
pg.display.set_caption("Текстовый редактор");
...
while True:
      ...
      if (ckey == "backspace"):
        ...
        if (lay_cur == "EN"):
          if ((ckey == "1") and ("right shift" in kp)):
            text = [f"{chr(0xA0)}#FFFFFF", ""];
          elif ((ckey == "2") and ("right shift" in kp)):
            text += [f"{chr(0xA0)}#FF0000", ""];
          elif ((ckey == "3") and ("right shift" in kp)):
            text += [f"{chr(0xA0)}#00FF00", ""];
          elif ((ckey == "4") and ("right shift" in kp)):
            text += [f"{chr(0xA0)}#0000FF", ""];
          elif ((ckey == "5") and ("right shift" in kp)):
            text += [f"{chr(0xA0)}#FFFFFF", ""];
          elif ((ckey == "6") and ("right shift" in kp)):
  ...
  Display.fill(BLACK);
  format_write(Display, font, text); Display.blit(font.render(lay_cur, True, WHITE), (W-38, H-35));
  pg.display.update();
  clock.tick(60);
